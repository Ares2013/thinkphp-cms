...
<script language="javascript" type="text/javascript" src="__ROOT__/Public/js/jquery.js"></script>
<script type="text/javascript">
	var totalsecond=parseInt("<?php echo ($waitSecond); ?>");
...
<div class="showMsg" style="text-align:center">
    ...
    <?php if(isset($jumpUrl)): ?>系统将在 <span id="waitsecond" style="color:blue;font-weight:bold"><?php echo ($waitSecond); ?></span>秒后自动跳转，如果不想等待，直接点击<a href="<?php echo ($jumpUrl); ?>">这里</a>
	<script language="javascript">
		setInterval("redirect();",1*1000);
    </script><?php endif; ?>
