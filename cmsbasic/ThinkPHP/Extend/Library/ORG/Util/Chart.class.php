...
class Chart extends Think{
  ...
  */
   ...
   * 
   */
  static function createhorizoncolumnar($title,$subtitle,$data=array(),$size=40,$height=100,$width=80,$legend=array()){
  	vendor("Jpgraph.jpgraph");
	vendor("Jpgraph.jpgraph_bar");
	$datay = $data;
	$datax = $legend;
  ...
  static function zhuzhuangxing($title,$subtitle,$data=array(),$size=40,$height=100,$width=80,$legend=array()){
  ...
  static function sanzhongzhuzhuangtu($title,$subtitle,$data=array(),$size=40,$height=100,$width=80,$legend=array()){
        vendor("Jpgraph.jpgraph");
	vendor("Jpgraph.jpgraph_bar");
