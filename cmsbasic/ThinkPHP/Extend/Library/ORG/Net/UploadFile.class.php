...
class UploadFile {//类定义开始
    ...
    private $config =   array(
		...
		'thumb_function'        =>  'resizeCanvas',       //缩略图策略 默认快速缩放 
    ...
    private function save($file) {
        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
				...
				$thumb_function		=	explode(',',$this->thumb_function);
                ...
                for($i=0,$len=count($thumbWidth); $i<$len; $i++) {
                    ...
                    Image::thumb($filename,$thumbPath.$thumbname.'.'.$thumbExt,'',$thumbWidth[$i],$thumbHeight[$i],false,$thumb_function[$i]);                    
                }
